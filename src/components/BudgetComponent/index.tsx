    ...
    <>
      ...
      >
        <View style={styles.content}>
          <View style={styles.category}>
            ...
            />
            <Text style={styles.budgetText}>{budget.description}</Text>
          </View>
          <View style={[styles.budget, !spent ? styles.budgetSolo : null ]}>
            <Text style={styles.PrimaryText}>Orçamento</Text>
      ...
      { showInfo && 
        <View style={styles.infoContainer}>
          <TouchableOpacity 
            style={styles.info}
            onPress={() => { navigate('BudgetForm', { budget }) }}
          >
            <FontAwesome5 
              name={'edit'}
              size={15} 
          ...
          <TouchableOpacity 
            style={styles.info}
            onPress={() => { navigate('BudgetCosts', { budget}) }}
          >
            <FontAwesome5 
